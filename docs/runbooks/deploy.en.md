# Runbook — sdkwork-account deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-account-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-account/bundle`, loads the image, starts
